...
function updateCart(pizza) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', pizza).then(function (res) {
    ...
    }).show(); // console.log(cartCounter.innerText)
  })["catch"](function (err) {
    new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
      type: 'error',
      timeout: 1000,
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.status = data.status; // console.log(updatedOrder.status)
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunkpizza_delivery_app"] = globalThis["webpackChunkpizza_delivery_app"] || [];
